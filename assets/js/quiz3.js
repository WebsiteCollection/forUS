(function() {
  var questions = [{
    question: "Which summarizes judicial review, as established in Marbury v. Madison?",
    choices: ["Supreme Court can review laws but cannot declare them unconstitutional", 
              "Supreme Court will always rule in favor of the law", 
              "Supreme Court can review and strike down unconstitutional laws", 
              "Supreme Court cannot decide between the Constitution and the law"],
    correctAnswer: 2
  }, {
    question: "What led to the War of 1812?",
    choices: ["Canadian invasion of New England", 
              "American involvement in European affairs", 
              "Burning of the White House by the British", 
              "Spanish invasion"],
    correctAnswer: 1
  }, {
    question: "How did the War of 1812 affect nationalism?",
    choices: ["Increased it due to a victory", 
              "No impact even though it was a defeat",
              "Increased it even though it was an indecisive conflict",
              "Reduced it because it was an indecisive conflict"],
    correctAnswer: 2
  }, {
    question: "What impact did the Transporation Revolution have on the economy?",
    choices: ["Greater stimulation and economic boom",  
              "Encouraged new inventions and boosted productivity", 
              "Little impact because of how much money was spent", 
              "Connected regional and national economies"],
    correctAnswer: 3
  }, {
    question: "What social consequence did the Second Great Awakening have?",
    choices: ["Focus on social justice led to equality for women and African Americans", 
              "Inspired dystopian communities", 
              "Inspired a variety of social movements", 
              "Led to cooperation between Protestants and Catholics"],
    correctAnswer: 2
  }, {
